...
handlers.on_console_error = wasm.__wbgtest_console_error;
        ...
        const tests = [];
    tests.push('__wbgt_it_works_0')
tests.push('__wbgt_test_get_fixed_prime_1')
tests.push('__wbgt_test_generate_phi_n_2')
tests.push('__wbgt_test_generate_key_pair_3')
tests.push('__wbgt_test_sra_4')
tests.push('__wbgt_test_sra_mock_5')
